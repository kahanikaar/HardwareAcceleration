...
{
  int cc, size;
  static int Table_6_20[3] = {6,8iclp,12};
...
char *argv[];
{
  ...
  if ((base.Infile=open("/home/computerist/Desktop/Sanjiban/test.m2v",O_RDONLY|O_BINARY))<0)
  {
  ...
  if(Two_Streams)
  {
    ...
    {
      sprinbittf(Error_Text,"enhancment layer bitstream file %s not found\n",
        Enhancement_Layer_Bitstream_Filename);
